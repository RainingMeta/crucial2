...
craftingTable.removeRecipe(<item:miningmaster:power_pyrite_block>);
craftingTable.removeRecipe(<item:miningmaster:power_pyrite>);
craftingTable.removeRecipe(<item:miningmaster:heart_rhodonite_block>);
craftingTable.removeRecipe(<item:miningmaster:heart_rhodonite>);
...
craftingTable.removeRecipe(<item:valhelsia_structures:cut_oak_post>);
craftingTable.removeRecipe(<item:valhelsia_structures:cut_spruce_post>);
craftingTable.removeRecipe(<item:valhelsia_structures:cut_birch_post>);
craftingTable.removeRecipe(<item:valhelsia_structures:cut_jungle_post>);
craftingTable.removeRecipe(<item:valhelsia_structures:cut_acacia_post>);
craftingTable.removeRecipe(<item:valhelsia_structures:cut_dark_oak_post>);
craftingTable.removeRecipe(<item:valhelsia_structures:cut_warped_post>);
craftingTable.removeRecipe(<item:valhelsia_structures:cut_crimson_post>);
